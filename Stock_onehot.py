...
merge_train_labels_onehot = np.asarray(merge_train_labels).astype('float32')
...
merge_val_labels_onehot = np.asarray(merge_val_labels).astype('float32')
#Table merge test
...
merge_test_labels_onehot = np.asarray(merge_test_labels).astype('float32')
...
model.add(layers.Dense(64,kernel_regularizer=regularizers.l2(0.001),activation='relu',input_shape=(24*300,)))
